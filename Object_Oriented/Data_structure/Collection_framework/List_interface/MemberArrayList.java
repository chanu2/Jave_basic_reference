...
public class MemberArrayList {
	private ArrayList<Member> arrayList;    // F1을 잘 이용해야 좋은 개발자가 될 수 있어요  // 아무것도 <>에 넣지않으면 object타입이 나온다
	...
	public boolean removeMember(int memberId) {
		...
		Iterator<Member> ir = arrayList.iterator(); // Iterator를 이용한 순회  --> 반환 받을 타입을 써야한다
